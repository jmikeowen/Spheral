...
#pragma omp critical
    {
      culledPairs.insert(culledPairs.size() - 1, culledPairs_thread.begin(), culledPairs_thread.end());
...
#pragma omp critical
            mNodePairList.insert(mNodePairList.size() - 1 , nodePairs_private.begin(), nodePairs_private.end());
